...
const worker = self;
const CACHE = "agentdeck-react-959de5382490";
worker.addEventListener('install', event => event.waitUntil((async () => { await (await caches.open(CACHE)).addAll(["/","/icon.svg","/manifest.webmanifest","/fonts.css","/fonts/inter-latin.woff2","/fonts/inter-latin-ext.woff2","/react/assets/Review-DR5PCwew.css","/react/assets/Review-yknlI8gi.js","/react/assets/app-CBdsxmmN.js","/react/assets/app-Cb4BDn83.css","/react/assets/terminal-B8KPvt2e.css","/react/assets/terminal-Cgf7k_q6.js"]); await worker.skipWaiting(); })()));
