...
const worker = self;
const CACHE = "agentdeck-react-d786b3aac015";
worker.addEventListener('install', event => event.waitUntil((async () => { await (await caches.open(CACHE)).addAll(["/","/icon.svg","/manifest.webmanifest","/fonts.css","/fonts/inter-latin.woff2","/fonts/inter-latin-ext.woff2","/react/assets/Review-DR5PCwew.css","/react/assets/Review-yknlI8gi.js","/react/assets/app-CLYnCZ7u.js","/react/assets/app-CzrUyhP_.css","/react/assets/terminal-BUhN6Qkr.js","/react/assets/terminal-CabX5hnp.css"]); await worker.skipWaiting(); })()));
