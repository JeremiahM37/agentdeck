export function openArchiveHistory({id,name,api}) {
  ...
  dialog.innerHTML='<header><h2>Archived terminal output</h2><button aria-label="Close archived output">×</button></header><p class="nh-name"></p><p role="status">Loading snapshot…</p><div class="nh-messages" tabindex="0"><pre style="white-space:pre-wrap;overflow-wrap:anywhere"></pre></div>';
